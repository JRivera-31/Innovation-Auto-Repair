        ...
        <div className={headerStyles.innerHeader}>
          ...
          <div className={headerStyles.navHolder}>
                <div 
                  ...
                  <div className={`${headerStyles.line} ${headerStyles["line-1"]} ${rotate1}`}></div>
                  <div className={`${headerStyles.line} ${headerStyles["line-2"]} ${rotate2}`}></div>
                  <div className={`${headerStyles.line} ${headerStyles["line-3"]} ${rotate3}`}></div>
                </div>
              </div>
